...
im=imread('Images/circle1.bmp'); r=r1-1; imagesc((36+r*cos(angles(2)))*px,imd.HeightPx-r*sin(angles(2))*px,im);
%Run script
run('b');
delete('b.m');
        end
